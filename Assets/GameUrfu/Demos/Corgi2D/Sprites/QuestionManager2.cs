...
public class QuestionManager2 : MonoBehaviour
{
    ...
    private string[] questions = {
        "Является ли биткойн первой криптовалютой?",
        "Можно ли потерять все свои средства, инвестируя в криптовалюты?",
        "Можно ли купить товары в интернет-магазинах за криптовалюту?"
    };

    private bool[] answers = { true, true, true }; // Массив правильных ответов
